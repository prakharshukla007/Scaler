...
public class CountSubarrayZeroSum {
    ...
    public static int solve(int[] A) {
        ...
        prefixSum[0] = A[0];
        for(int i=1; i<n; i++) prefixSum[i] = (long)prefixSum[i-1] + A[i];
        ...
        for(int i=0; i<n; i++) {
            if(prefixSum[i] == 0) {
                System.out.print("Zero Line : " + count1++);
                count++;
            }
            if(set.contains(prefixSum[i])) {
                System.out.println("Repeat Line : " + count2++);
                count++;
            }
//            System.out.println();
            set.add(prefixSum[i]);
